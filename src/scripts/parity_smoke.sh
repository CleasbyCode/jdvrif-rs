...
for source in \
    reddit_steg.h reddit_steg.cpp \
    twitter_jpeg_codec.h twitter_jpeg_codec.cpp \
    twitter_juniward.h twitter_juniward.cpp \
    twitter_stc.h twitter_stc.cpp \
    twitter_steg.h twitter_steg.cpp; do
...
echo "Carrier source parity passed: Reddit and X-Twitter carrier sources match C++."
