...
# across {default, -b Bluesky, -r Reddit, -x X-Twitter}. Proves C++ <-> Rust interop for the
...
#
# Usage: bash rust_port/src/scripts/interop_matrix.sh
...
# conceal with $1, mode $2 ('' | -b | -r | -x), cover $3, payload $4, in dir $5.
...
run_case twitter_text     "-x" "$COVER_DIR/cover_default.jpg" "$WORK/p_text.txt"
